package com.jzsoft.platform.module.dictionary.service;
...
import com.jzsoft.platform.module.dictionary.dao.DictionaryDAO;
import com.jzsoft.platform.module.dictionary.dao.DictionaryValueDAO;
...
public class DictionaryValueService {
	...
	public Map<String, String> getDictValueMapWithDictCode(String dictCode) {
		...
		List<DictionaryValue> dictionaryValues =this.getListWithDictCode(dictCode);
		for(DictionaryValue dictionaryValue:dictionaryValues){
