package com.jzsoft.platform.component.attachment.aspect;
...
import com.jzsoft.platform.component.attachment.annotation.AttachmentField;
...
public class AttachmentAspect {
	 ...
	 * @throws IOException
	 */
	@AfterReturning("execution(* com.jzsoft.platform.core.dao.BaseDAO.save(..)) || execution(* com.jzsoft.platform.core.dao.BaseDAO.update(..)) || execution(* com.jzsoft.platform.core.dao.BaseDAO.saveOrUpdate(..))")
	...
	@Before("execution(* com.jzsoft.platform.core.dao.BaseDAO.delete(..)) ")
