package com.jzsoft.platform.component.attachment.util;
...
import com.jzsoft.platform.core.web.listener.RequestContextMonitor;

@Component("fw_AttachmentClearFtpCache")
public class AttachmentClearFtpCache implements RequestContextMonitor {

	public static final String DEL_FTP_FILE_ATTR_NAME = "com.jzsoft.framework.component.attachment.util.AttachmentClearFtpCache_DEL_FTP_FILE_ATTR_NAME";
