	...
	function loadUploadFlash(param){
		...
		if(param.existAttachments && param.existAttachments.length>0){
			...
			$(param.existAttachments).each(function(){
				var uf = this;
				htmlLi += "<li id='"+ uf.id + "'>";
				htmlLi += "	<img src='" + com.ue.global.path + "/platform/component/swfupload/images/0.gif' alt='' />&nbsp";
...
//				},
	...
	function setAttachmentId(ufId,attachmentId){
		...
		$("#" + divId + "Pb"+ ufId).html("");
		$("#" + divId + "Img"+ ufId)[0].src = com.ue.global.path + "/platform/component/swfupload/images/2.gif";
	...
	function addNewFile(file){
		...
		//添加单个文件
		var html = "";
		html += "<li id='" + divId + "Li" + uf.id + "'>";
		html += "	<img id='" + divId + "Img" + uf.id + "' src='" + com.ue.global.path + "/platform/component/swfupload/images/0.gif' alt='' />&nbsp";
	...
	function getUploadUITemp(){
		...
		html += "		<span class='ml10 pt5 clearfix'>" + $.i18n.prop('upload_hasAttachment') + "</span>";
