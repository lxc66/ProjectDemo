		...
		<div class="formLayout01">
			...
			<div class="formItem">
			     ...
			     <div class="bdmain">
			     	...
			     	<uc:radio required="true" fieldValue="2" label="FastDFS保存" value="${model.type }" name="model.type"></uc:radio>
			     </div>
			</div>
			<div class="formItem">
			...
			<div class="formItem">
				...
				<a onclick="com.ue.platform.module.attachment.attachmentSetting.doAdd();" class="button btnGreen" href="javascript:void(0);">保存</a>
			</div>
		</div>
	</uc:form>
</div>