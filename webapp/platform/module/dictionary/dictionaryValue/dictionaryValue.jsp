...
$(document).ready(function() {
	$("#${pageId}list").closest("div.ui-layout-pane").removeClass("inLayout-center");
			...
			<a class='button mb5' href='javascript:void(0);' onclick='com.ue.platform.module.dictvalue.toAdd()'><span class='fm f8 mr5'>+</span>添加</a>
			<uc:form id="${pageId}theForm" method="post">
				<!-- Begin search -->
	                <table id="${pageId}list" multiselect="true" pager="pager" toolbar="true" class="cssTableBody">
						<thead>
							<tr>
