	...
	com.ue.platform.module.dictvaluetree.refresh();
			...
			<uc:form action="dictValue!list" id="${pageId}theForm" method="post">
				<div class="m5">
					...
					<a class='button small' href='javascript:void(0);' onclick='com.ue.platform.module.dictvaluetree.toEdit();'><span class="fm f8 mr5"></span>修改</a>
					<a class='button small' href='javascript:void(0);' onclick='com.ue.platform.module.dictvaluetree.toSort();'><span class="fm f8 mr5"></span>排序</a>
				</div>
