...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		<c:if test="${empty model.id}">
			$("#${pageId }fileDiv").swfupload({classFieldName:"com.jzsoft.platform.demo.model.User,id"});
		</c:if>
		<c:if test="${not empty model.id}">
			$("#${pageId }fileDiv").swfupload({classFieldName:"com.jzsoft.platform.demo.model.User,id",idOwner:"${model.id}"});
		</c:if>
	})
</script>
