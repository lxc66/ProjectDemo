			...
			<div id="accordion">
				...
				<div>
					<ul class="navMain">
						...
						<li>
							<a href="javascript:;" url="${path}/demo/component/tabs/tabs-demo.jsp">
								<span>选项卡</span>
							</a>
						</li>
						<li>
							<a href="javascript:;" url="${path}/demo/component/jqGrid/jqGrid-demo.jsp">
								<span>数据表格</span>
							</a>
						</li>
						<li>
							<a href="javascript:;" url="${path}/demo/component/autocomplate/autocomplate-demo.jsp">
								<span>自动完成</span>
							</a>
						</li>
					</ul>
