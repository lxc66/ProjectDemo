	...
	<div class="box1 fl" boxTitle="下拉树">
		...
		<div style="margin-top: 10px;margin-left: 10px;margin-right: 10px;">
			...
			<uc:tree nodes="[{id:1, pId:0, name:'北京',isParent:true},{id:2, pId:0, name:'天津'},{id:4, pId:0,name:'河北省',open:true,url:'http://www.taobao.com',nodes:[{id:41, pId:4, name:'石家庄'},{id:42, pId:4, name:'张家口',nodes:[{id:421,pId:42,name:'涿鹿',nodes:[{id:4211,pId:421,name:'西关村'}]}]}]}]" 
			 id="dropdownTree1" dropdown="true" checkEnable="true" checkValue="4,41" name="model.region" required="true" width="300" showParentName="true"></uc:tree>
		</div>
	...
	<table class="cssTableBody">
		...
		<tr>
		   ...
		   <td>
		   		...
		   		id:结点ID<br/>
		   		checked:勾选 或 取消勾选状态（true/false）<br/>
		   		示例：$.hz.ztree.checkNodeWithId("treeDemo","1143",true);
		   </td>
		</tr>
		<tr>
		   <td>selectNode</td>
		   <td>
		  		 选中指定节点，参数说明：<br/>
		  		treeNode：节点数据<br/>
		  		selected:选择 或 取消选择状态（true/false）<br/>
		  		addFlag： 是否追加选中，会出现多点同时被选中的情况（true/false）<br/>
		  		 示例：$.hz.ztree.selectNode("treeDemo",treeNode,true,false);
		   </td>
		</tr>
		<tr>
		   <td>selectNodeWithId</td>
		   <td>
		   		根据Id选中指定节点，参数说明：<br/>
		   		id：结点ID<br/>
		   		selected:选择 或 取消选择状态（true/false）<br/>
		  		addFlag： 是否追加选中，会出现多点同时被选中的情况（true/false）<br/>
		   		示例：$.hz.ztree.checkNodeWithId("treeDemo","1143",true,false);
		   </td>
		</tr>
		<tr>
...
// 		$.hz.ztree.expandNodeWithId("checkboxTree","4211"); 
	}
