<!DOCTYPE html>
<%@page import="com.jzsoft.demo.model.TestObject"%>
...
<div class="box1" boxTitle="1、JS使用方法">
	...
	<pre class="syntax brush-javascript">
		$.hz.swfupload.init("fileDiv",{configCode:"userPhoto",classFieldName:"com.jzsoft.platform.demo.model.User,id"});
	</pre>
	...
	<table class="cssTableBody">
		...
		<tr>
		   ...
		   <td>
		  		 ...
		  		 示例：$.hz.swfupload.init("fileDiv",{classFieldName:"com.jzsoft.platform.demo.model.User,id"});
		   </td>
		</tr>
		<tr>
		   <td>idOwner</td>
		   ...
		   <td>
		   		修改表单回显已上传的附件时用到idOwner，此属性对应与附件关联的实体中的属性值<br/>
		   		 示例：$.hz.swfupload.init("fileDiv",{classFieldName:"com.jzsoft.platform.demo.model.User,id" , idOwner:"userId"});
		   </td>
		</tr>
		<tr>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		$(".box1").box1();
		$.hz.swfupload.init("fileDiv",{classFieldName:"com.jzsoft.platform.demo.model.User,id"});
