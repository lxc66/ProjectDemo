...
<body id="aabb">
	...
	<input id="type" name="type" type="hidden"
		value="${sessionScope.usrid}">
	<input type="text" name="type" id="id" style="display: none;"
		value="${entity.id}">
					...
					function() {
						...
						if ($(this).hasClass("fa-thumbs-o-up")) {
							...
							if (tokens.trim() != null && tokens.trim() != "") {
								$.ajax({
									type : "POST",
									url : "/notoken/dianZanTconsultation",
									data : {
										"id" : aa,"userId":tokens,"cId":zxid
									},
							...
							$.ajax({
								type : "POST",
								url : "/notoken/deleteDianZanTconsultation",
								data : {
									"id" : aa,"userId":tokens,"cId":zxid
								},
								success : function(msg) {
